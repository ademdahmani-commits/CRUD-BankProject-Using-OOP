...
class clsTransactionsScreen : protected clsScreen
{
    enum enTransactionsMenueOptions {
        ...
        eShowTotalBalance = 3, eMoneyTransfer = 4, TransferLog = 5,
        eShowMainMenue = 6 
    ...
    static void _ShowMoneyTransferLog() {
        //cout << "\nMoney Transfer Screen Will be here...\n";
    ...
    static void _PerformTransactionsMenueOption(enTransactionsMenueOptions Option) {
        ...
        case enTransactionsMenueOptions::eDeposit:
            ...
            case enTransactionsMenueOptions::eMoneyTransfer:
                system("cls");
                _ShowMoneyTransferScreen();
                _GoBackToTransactionsMenue();
                break;
                case enTransactionsMenueOptions::TransferLog:
                system("cls");
                _ShowMoneyTransferLog();
                _GoBackToTransactionsMenue();
                break;
...
public: 
    ...
    static void ShowTransactionsMenue()
    {
        ...
        cout << setw(37) << left << "" << "\t[4] Money Transfer.\n";
